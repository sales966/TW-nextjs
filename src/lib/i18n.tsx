...
const dictionaries = {
  en: {
    ...
    quote: {
      ...
      fname: "First Name", lname: "Last Name", email: "Email Address", phone: "Phone Number", comp: "Company Name", qty: "Estimated Quantity", msg: "Project Details & Specific Requirements", submit: "Submit Inquiry",
  ...
  zh: {
    ...
    quote: {
      ...
      fname: "名字", lname: "姓氏", email: "电子邮箱", phone: "联系电话", comp: "品牌或公司名称", qty: "预估采购数量", msg: "项目细节与其他特殊要求", submit: "提交询价申请",
  ...
  tw: {
    ...
    quote: {
      ...
      fname: "名字", lname: "姓氏", email: "電子信箱", phone: "聯絡電話", comp: "品牌或公司名稱", qty: "預估採購數量", msg: "專案細節與其他特殊要求", submit: "提交詢價申請",
