...
const dictionaries = {
  en: {
    ...
    quote: {
      ...
      uploadTitle: "Upload Design / Reference", uploadDesc: "Supported formats: PDF, AI, PSD, JPG, PNG. Max size: 100MB.", uploadErr: "File size exceeds 100MB limit. Please select a smaller file.",
  ...
  zh: {
    ...
    home: {
      heroTag: "专业定制纸袋制造商",
      heroT1: "为现代品牌", heroT2: "打造高质感定制", heroT3: "纸袋包装方案",
      ...
      caseTitle: "合作案例",
      caseSub: "我们为美妆、时尚、食品等多个行业的品牌，提供定制化的包装解决方案。",
      caseLink: "查看完整案例",
      cases: [
      ...
      whys: [
        ...
        { t: "灵活的定制选项", d: "支持各种独特的尺寸比例、特殊打孔需求，以及精准的 Pantone 专色调配。" },
      ...
      susTitleH1: "致力于推动",
      susTitleH2: "可持续包装的发展",
      susSub: "从源头严格把控纸张来源，并在生产环节中践行环保准则。我们期望通过可降解材料的普及，为您的品牌赋予更强的社会责任感与绿色生态背书。",
      susList: ["FSC® 森林管理委员会认证纸源", "符合环保标准的大豆油墨印刷", "推广全面可回收、易降解材料", "倡导使用全棉等环保可回收提手"],
      
      faqTitle: "常见问题解答",
      faqs: [
        { q: "纸袋的定制起订量 (MOQ) 一般是多少？", a: "常规定制纸袋通常为 1,000 个起订。如果是手工工艺复杂的高级精品袋，也支持较小的打样测试量；对于全自动机型的大批量投产，数量越多单价越有竞争力。" },
        { q: "尺寸、材质或工艺可以做到完全量身定制吗？", a: "当然可以。从专属的长宽比例、承重底板的厚度，到满版印刷以及提手材质（如棉绳、纸扭绳等），均能根据您的要求进行深度定制。" },
        { q: "定版与打样周期需要多长时间？", a: "空白结构白样通常需要 3-5 个工作日；如果是包含全彩印刷与烫金等特殊工艺的实物彩样，一般需要 7-10 个工作日准备。" },
        { q: "您公司提供的包装材质是环保的吗？", a: "是的。我们为客户提供丰富的、合乎国际环保标准的纸张选择，并坚持采用环保粘结剂和大豆油墨进行加工生产。" },
        { q: "是否支持货物出口及全球物流运输？", a: "支持。我们拥有丰富的出口出货与包装规范经验，可以协助您办理面向全球主要港口的海运与空运配送流程。" }
      ],
    ...
    quote: {
      title: "定制需求表单", sub: "请尽可能详细地说明您的包装规格要求（如具体尺寸、印刷工艺等），帮助我们更快速、精准地为您提供出厂预估价。",
      ...
      uploadTitle: "上传设计图或参考文件", uploadDesc: "支持的格式：PDF, AI, PSD, JPG, PNG。文件大小限制：100MB", uploadErr: "文件大小超过100MB限制，请重新选择",
      formB1: "需求产品与数量", formB2: "尺寸规格与设计细节", formB3: "获取报价的联络方式",
      btnBack: "上一步", btnNext: "下一步",
      opt1: "1,000 - 5,000 件", opt2: "5,000 - 20,000 件", opt3: "20,000 - 100,000 件", opt4: "100,000 件以上",
      ph: "参考示例：尺寸要求为 长400 x 高300 x 侧宽150 mm。推荐使用 250克棕色牛皮纸。外观带有单色印刷标志，采用扭纹纸绳作为提手等...",
      doneT: "需求清单提交成功", doneS: "我们的包装顾问已经收到您的信息。稍后我们将与您联系，进一步确认细节并提供正式报价单。"
    },
    footer: {
  ...
  tw: {
    ...
    home: {
      heroTag: "專業客製紙袋製造商",
      heroT1: "為現代品牌", heroT2: "打造高質感客製", heroT3: "紙袋包裝方案",
      ...
      caseTitle: "合作案例",
      caseSub: "我們為美妝、時尚、食品等多個行業的品牌，提供客製化的包裝解決方案。",
      caseLink: "查看完整案例",
      cases: [
      ...
      whys: [
        ...
        { t: "靈活的客製選項", d: "支持各種獨特的尺寸比例、特殊打孔需求，以及精準的 Pantone 專色調配。" },
      ...
      susTitleH1: "致力於推動",
      susTitleH2: "永續包裝的發展",
      susSub: "從源頭嚴格把控紙張來源，並在生產環節中踐行環保準則。我們期望透過可降解材料的普及，為您的品牌賦予更強的社會責任感與綠色生態背書。",
      susList: ["FSC® 森林管理委員會認證紙源", "符合環保標準的大豆油墨印刷", "推廣全面可回收、易降解材料", "倡導使用全棉等環保可回收提手"],
      
      faqTitle: "常見問題解答",
      faqs: [
        { q: "紙袋的客製起訂量 (MOQ) 一般是多少？", a: "常規客製紙袋通常為 1,000 個起訂。如果是手工工藝複雜的高級精品袋，也支持較小的打樣測試量；對於全自動機型的大批量投產，數量越多單價越有競爭力。" },
        { q: "尺寸、材質或工藝可以做到完全量身客製嗎？", a: "當然可以。從專屬的長寬比例、承重底板的厚度，到滿版印刷以及提手材質（如棉繩、紙扭繩等），均能根據您的要求進行深度客製。" },
        { q: "定版與打樣週期需要多長時間？", a: "空白結構白樣通常需要 3-5 個工作日；如果是包含全彩印刷與燙金等特殊工藝的實物彩樣，一般需要 7-10 個工作日準備。" },
        { q: "您公司提供的包裝材質是環保的嗎？", a: "是的。我們為客戶提供豐富的、合乎國際環保標準的紙張選擇，並堅持採用環保黏結劑和大豆油墨進行加工生產。" },
        { q: "是否支持貨物出口及全球物流運輸？", a: "支持。我們擁有豐富的出口出貨與包裝規範經驗，可以協助您辦理面向全球主要港口的海運與空運配送流程。" }
      ],
    ...
    quote: {
      title: "客製需求表單", sub: "請盡可能詳細地說明您的包裝規格要求（如具體尺寸、印刷工藝等），幫助我們更快速、精準地為您提供出廠預估價。",
      ...
      uploadTitle: "上傳設計圖或參考文件", uploadDesc: "支援的格式：PDF, AI, PSD, JPG, PNG。檔案大小限制：100MB", uploadErr: "檔案大小超過100MB限制，請重新選擇",
      formB1: "需求產品與數量", formB2: "尺寸規格與設計細節", formB3: "獲取報價的聯絡方式",
      btnBack: "上一步", btnNext: "下一步",
      opt1: "1,000 - 5,000 件", opt2: "5,000 - 20,000 件", opt3: "20,000 - 100,000 件", opt4: "100,000 件以上",
      ph: "參考示例：尺寸要求為 長400 x 高300 x 側寬150 mm。推薦使用 250克棕色牛皮紙。外觀帶有單色印刷標誌，採用扭紋紙繩作為提手等...",
      doneT: "需求清單提交成功", doneS: "我們的包裝顧問已經收到您的信息。稍後我們將與您聯繫，進一步確認細節並提供正式報價單。"
    },
    footer: {
